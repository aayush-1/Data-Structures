  ...
  struct BST *x;
    if(root!=NULL)
    {
        ...
        while(temp!=NULL)
        {
            ...
            if(compare(head,temp->pointer)==2)
            { 
              x = temp;
                break;
            }
            else if(compare(head,temp->pointer)==0)
            {
...
void uncle()
{
	...
	if(root!=NULL)
    {
        ...
        if(temp->parent->parent->left==temp->parent)
        {
        	...
        	{
        		display1(temp->parent->parent->right->pointer);
        		printf("\n");
        	}
        	else
        	{
        ...
        if(temp->parent->parent->right==temp->parent)
        {
        	...
        	{
        		display1(temp->parent->parent->left->pointer);
        		printf("\n");
        	}
        	else
        	{
